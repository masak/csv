...
is($before, $after,
  'Writes file with single quote as quoting character correctly');
csv-write-file(@csv, :file($out), :quote('@') );
...
is($before, $after,
  'Writes file with "@" as quoting character correctly');
...
is($before, $after,
  'Writes file with Tab as separator character correctly');
