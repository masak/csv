...

{
    ...
    dies_ok { csv-write-file(file => $out, @csv) }, 'Dies if no header is prvided in hash mode';
...

{
    ...
    is($before, $after, 'Hash output for parse / write with given header on pretty.csv round-trips');
}
