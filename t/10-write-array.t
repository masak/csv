...

{
    ...
    $after = slurp $out;
    is($before, $after,
      'Array output for parse / write on pretty.csv round-trips');
}

{
    ...
    $after = slurp $out;
    is($before, $after,
      'Array output for parse / write on ugly.csv round-trips');
}

{
    ...
    $after = slurp $out;
    is($before, $after,
      'Parse with skip-header / write with given header on pretty.csv ok');
}
